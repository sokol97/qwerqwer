...
def _make_request(token, method_name, method='get', params=None, files=None, title=None):
    """
    ...
    # Тут хранится название файла (file_name)
    # a = result.content.decode(encoding='utf-8')
    # try:
    #     b = json_result['result']['audio']['file_name']
    #     b = title
    # b = b.message_id
    #     print(b)
    # except:
...
def send_audio(token, chat_id, audio, caption=None, duration=None, performer=None, title=None, reply_to_message_id=None,
    ...
    return _make_request(token, method_url, params=payload, files=files, method='post', title=title)
