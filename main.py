...
#         self.setupUi(self)
#         self.show()
#         self.Button_sp500.clicked.connect(self.sp500)
#
#     def sp500(self):
#         client.send_message(f'@{self.linetgnik.text()}', "Привет")
#         print(f'@{self.linetgnik.text()}')
#
#     @client.message_handler(commands=['sms'])
